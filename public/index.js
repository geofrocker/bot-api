...
var OPENAI_API_URL = '/.netlify/functions/api';
var conversationArr = [];
...
function fetchReply() {
  return _fetchReply.apply(this, arguments);
}
function _fetchReply() {
  _fetchReply = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          console.error('Error fetching response from server:', _context.t0);
        case 14:
        case "end":
...
function renderAllResponses() {
  ...
  conversationArr.forEach(function (message, index) {
    if (message.role === 'assistant') {
      ...
      responseDiv.innerHTML += "\n                <p><strong>Me:</strong> ".concat(message.content, "</p>\n            ");
    }
  });
}